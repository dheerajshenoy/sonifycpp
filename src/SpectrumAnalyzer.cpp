...
SpectrumAnalyzer::SpectrumAnalyzer(QWidget *parent) noexcept : QDialog(parent)
{
    ...
    m_plot->setInteractions(QCP::iSelectAxes | QCP::iRangeDrag
                            | QCP::iRangeZoom);
...
void
SpectrumAnalyzer::setData(const QVector<short> &data,
...
void
SpectrumAnalyzer::keyPressEvent(QKeyEvent *e) noexcept
{
