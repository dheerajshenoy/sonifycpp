...
void SDLCALL
ToneGenerator::audioCallback(void *userdata,
...
std::vector<short>
ToneGenerator::generateSineWave(double _amplitude,
                                double frequency,
...
std::vector<short>
ToneGenerator::generateSquareWave(double _amplitude,
                                  double frequency,
                                  double time) noexcept {
    const int N         = static_cast<int>(m_sampleRate * time);
    const int amplitude = static_cast<int>(_amplitude * 32767);
...
std::vector<short>
ToneGenerator::generateTriangularWave(double _amplitude,
                                      double frequency,
                                      double time) noexcept {
    std::vector<short> fs;
...
std::vector<short>
ToneGenerator::generateSawtoothWave(double _amplitude,
                                    double frequency,
                                    double time) noexcept {
    std::vector<short> fs;
    int N = static_cast<int>(m_sampleRate * time);
